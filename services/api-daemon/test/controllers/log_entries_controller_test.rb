...
class LogEntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create log_entry" do
    assert_difference('LogEntry.count') do
      post log_entries_url, params: { log_entry: { details: @log_entry.details, failing: @log_entry.failing, message_id: @log_entry.message_id } }
    end
  ...
  test "should update log_entry" do
    patch log_entry_url(@log_entry), params: { log_entry: { details: @log_entry.details, failing: @log_entry.failing, message_id: @log_entry.message_id } }
